...
// findLeftRepetitions finds number of character repetitions in the string
...
func DeIndent(inString string) string {
	...
	// if empty after trimming add a newline
	// TODO: compress multiple newlines to one
	...
	// add trailing new line if one has been detected above,
	// we do this here to avoid wrong indentation detection
	if trailingNewline {
